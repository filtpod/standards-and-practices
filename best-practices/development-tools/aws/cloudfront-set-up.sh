...
This script automates the CloudFront set up process as documented in https://github.com/filtpod/standards-and-practices/blob/main/aws/s3-cloudfront-deployment.md.
